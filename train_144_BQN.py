...
env = gym.make(f"gym-PBN/PBNEnv",
               N=args.size,
               genes=["v_ACVR1", "v_AKT1S1", "v_AKT_f", "v_AP1_c", "v_ARHGAP24", "v_ATF2", "v_AXIN1", "v_Antisurvival",
                      "v_BAD", "v_BAX", "v_BCL2", "v_BMPR2", "v_BTRC", "v_CASP3", "v_CASP8", "v_CASP9", "v_CBPp300_c",
                      "v_CCND1", "v_CDC42", "v_CFLAR", "v_CFL_f", "v_CHUK", "v_CK1_f", "v_CREBBP", "v_CSK", "v_CTNNB1",
                      "v_CYCS", "v_DAAM1", "v_DKK_f", "v_DKK_g", "v_DUSP1", "v_DUSP1_g", "v_DUSP6", "v_DVL_f", "v_EGR1",
                      "v_EP300", "v_ERK_f", "v_FOS", "v_FOXO_f", "v_FZD_f", "v_GAB_f", "v_GRAP2", "v_GRB2", "v_GSK3_f",
                      "v_IKBKB", "v_ILK", "v_ILR_f", "v_IRAK1", "v_IRS1", "v_ISGF3_c", "v_ITCH", "v_JAK_f", "v_JNK_f",
                      "v_JUN", "v_KRAS", "v_LEF1", "v_LIF", "v_LIMK1", "v_LIMK2", "v_LRP_f", "v_MAP2K3", "v_MAP2K4",
                      "v_MAP2K7", "v_MAP3K11", "v_MAP3K4", "v_MAP3K5", "v_MAP3K7", "v_MAP3K8", "v_MAPK14", "v_MAPK8IP3",
                      "v_MAPKAPK2", "v_MDM2", "v_MDM2_g", "v_MEK_f", "v_MMP_f", "v_MSK_f", "v_MYC", "v_NFKB_f", "v_NLK",
                      ...
                      "v_RSK_f", "v_RTPK_f", "v_RTPK_g", "v_S6K_f", "v_SFRP1", "v_SFRP1_g", "v_SHC1", "v_SKI", "v_SKP2",
